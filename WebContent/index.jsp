...
<tr><td><font color=tan size=4 face="Verdana">Phone Number :    </font></td><td>  <input type="text" name="Phone"  onclick="this.value=''"/></td></tr>
...
<!-- <tr><td><font color=tan size=4 face="Verdana">PASSWORD :   </font></td><td>  <input type="password" name="Password"  required onclick="this.value=''"/></td></tr> -->
